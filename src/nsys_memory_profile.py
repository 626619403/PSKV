...
def run_profiling(model_id, dataset_name, kv_cache_mode, save_dir,
                  ...
                  search_width=64, datacollator="llama2-chat", batch_size=16):
...
def main():
    ...
    parser.add_argument("--kv-modes", type=str, nargs="+",
                    default=["None", "Normal", "Ours"],
                    help="Which KV cache modes to profile")
